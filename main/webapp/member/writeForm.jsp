...
<body>
<form name="writeForm" id="writeForm" method="post" action="http://localhost:8090/miniProject/member/write.do">
...
$('input[name="checkIdBtn"]').click(function(){
	...
	if(sId=="") {
		...
		window.open("/miniProject/member/checkId.do?id="+sId,"checkId","width=450 height=150 left=700 top=300");
		//이름주면 안열림(중간에넣는값)
	}
